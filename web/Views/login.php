                ...
                <div class="row card">
                    <div class="col-md-5 left">
                        <div class="image-login">
                            <img src="https://images.unsplash.com/photo-1615663245857-ac93bb7c39e7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=465&q=80" alt="" width="100%" style="
                    ...
                    <div class="col-md-7 right">
                        ...
                        <form role="form" name="loginForm" action="/login" method="POST">
                            ...
                            <div class="form-group">
                                <input values='<?= isset($data['email']) ? $data['email'] : ""  ?>' type="email" class="form-control form-input" id="" placeholder="Email"  name="email">
