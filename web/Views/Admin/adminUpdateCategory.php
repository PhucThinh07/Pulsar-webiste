                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    if (isset($data)) {
                                        foreach ($data as $cat) {
                                    ?>
                                            <form action="/admin/updatecat" method="POST" role="form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?= $cat['cat_name']?? '' ?> " name="catName" type="text" class="form-control" id="" placeholder="Nhập tên danh mục sản phẩm">
                                                </div>
                                                <button type="submit" class="btn btn-primary" style="background-color:#0080FF">Cập nhật</button>
