                        ...
                        <div class="panel-body">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    ?>
                                            <form action="/admin/updateprod" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="id" value="<?= $prod['id'] ?>">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="">Tên sản phẩm</label>
                                                            <input type="text" class="form-control" id="" placeholder="Nhập tên sản phẩm" name="product_name" value="<?= $prod['product_name'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="">Hình sản phẩm</label>
                                                            <input type="file" class="form-control" id="" placeholder="Nhập tên sản phẩm" name="image" value="<?= $prod['product_image'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="">Giá sản phẩm</label>
                                                            <input type="text" class="form-control" id="" placeholder="Nhập giá sản phẩm" name="product_price" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" value="<?= $prod['product_price'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <textarea id="mytextarea" name="product_description" class="form-control" rows="7"><?= $prod['product_description'] ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
